...
import PaymentsCashfreeDashboardPagination from "components/PaymentsCashfreeDashboardPagination";
import PaymentsCashfreeDashboardRowframe2282 from "components/PaymentsCashfreeDashboardRowframe2282";
import PaymentsCashfreeDashboardTabletype from "components/PaymentsCashfreeDashboardTabletype";
import PaymentsCashfreeDashboardTabletype1 from "components/PaymentsCashfreeDashboardTabletype1";
import PaymentsCashfreeDashboardTabletype2 from "components/PaymentsCashfreeDashboardTabletype2";
      ...
      <div className="bg-gray-50 flex flex-col font-inter items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          >
            ...
            >
              <div className="flex flex-col gap-[3.86px] items-center justify-start w-full">
          ...
          <div className="flex flex-1 flex-col gap-8 items-center justify-start md:px-5 w-full">
            <PaymentsCashfreeDashboardRowframe2282 className="bg-white-A700 border-b border-blue_gray-100 border-solid flex md:flex-col flex-row gap-4 items-center justify-start max-w-[1216px] sm:px-5 px-8 py-3 w-full" />
                  ...
                  <div className="flex flex-col gap-3 items-end justify-start w-auto md:w-full">
                    ...
                    <div className="bg-gray-100 gap-10 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 items-center justify-start max-w-[1128px] px-3 py-2.5 rounded w-full">
                      <div className="flex flex-1 flex-col items-start justify-center w-full">
                        <div className="flex flex-col items-center justify-start w-auto">
                          <PaymentsCashfreeDashboardTabletype className="flex flex-col gap-4 items-center justify-start w-auto" />
                        </div>
                      </div>
                      <div className="flex flex-1 flex-col items-start justify-center w-full">
                        <div className="flex flex-row gap-1 items-center justify-start w-auto">
                          <PaymentsCashfreeDashboardTabletype
                      ...
                      <div className="flex flex-col gap-3.5 items-center justify-start w-full">
                        <div className="gap-10 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 items-center justify-between w-full">
                          <div className="bg-white-A700 flex flex-1 flex-col items-start justify-center w-full">
                            <PaymentsCashfreeDashboardTabletype1 className="flex flex-col gap-4 items-center justify-start w-auto" />
                          </div>
                          <div className="bg-white-A700 flex flex-1 flex-col items-start justify-center w-full">
                            <PaymentsCashfreeDashboardTabletype2 className="flex flex-col gap-4 items-center justify-start w-auto" />
                          </div>
                          <div className="bg-white-A700 flex flex-1 flex-col items-end justify-center w-full">
                            <PaymentsCashfreeDashboardTabletype2
                              className="flex flex-col gap-4 items-center justify-start w-auto"
                              datetext="₹1,278.23"
                            />
                          </div>
